...
if((sizeof($result)) < 1){
	...
	//DAY1
	//get meal plan's day1 daily_meal_id
	// Free stmt set
	$stmt = null;
	$stmt = $conn->query("call get_current_daily_meal_day1('$mpID')");
	if ($stmt){
		...
		echo ("Error: Cannot find day 1 daily_meal");
	}

	//DAY2
	//get meal plan's day2 daily_meal_id
	// Free stmt set
	$stmt = null;
	$stmt = $conn->query("call get_current_daily_meal_day2('$mpID')");
	if ($stmt){
		$daily = $stmt ->fetchall(PDO::FETCH_ASSOC);
		$dmID = $daily[0]['day2'];
		...
		echo ("Error: Cannot find day 2 daily_meal");
	}


	//DAY3
	//get meal plan's day3 daily_meal_id
	// Free stmt set
	$stmt = null;
	$stmt = $conn->query("call get_current_daily_meal_day3('$mpID')");
	if ($stmt){
		$daily = $stmt ->fetchall(PDO::FETCH_ASSOC);
		$dmID = $daily[0]['day3'];
		...
		echo ("Error: Cannot find day 3 daily_meal");
	}


	//DAY4
	//get meal plan's day4 daily_meal_id
	// Free stmt set
	$stmt = null;
	$stmt = $conn->query("call get_current_daily_meal_day4('$mpID')");
	if ($stmt){
		$daily = $stmt ->fetchall(PDO::FETCH_ASSOC);
		$dmID = $daily[0]['day4'];
		...
		echo ("Error: Cannot find day 4 daily_meal");
	}


	//DAY5
	//get meal plan's day5 daily_meal_id
	// Free stmt set
	$stmt = null;
	$stmt = $conn->query("call get_current_daily_meal_day5('$mpID')");
	if ($stmt){
		$daily = $stmt ->fetchall(PDO::FETCH_ASSOC);
		$dmID = $daily[0]['day5'];
		...
		echo ("Error: Cannot find day 5 daily_meal");
	}
