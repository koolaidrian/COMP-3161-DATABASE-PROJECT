window.onload = function () {
    /*var cal = document.getElementById("meal_calorie");
    sessionStorage.setItem("mCal", cal.value);*/
...
function ready() {
    ...
    document.addEventListener("click", function (e) {
        if (e.target && e.target.id == 'random-btn') {
            randomPlan();
        }
...
function randomPlan() {
    let url = "./assets/php/RandomMealPlan.php";
